...
const CausesUpdateModal = ({ id }: { id: string }) => {
...
console.log('row',data);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger className="bg-primary md:px-4 px-2 md:py-2 py-1 rounded-full flex gap-2 items-center justify-center">
        Update <MdOutlineEdit className="text-lg"/>
      </DialogTrigger>
