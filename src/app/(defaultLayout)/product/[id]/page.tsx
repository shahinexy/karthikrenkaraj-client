      ...
      <div className="grid md:grid-cols-5 grid-cols-1 md:gap-16 gap-3 md:p-7 p-3 bg-white rounded-3xl">
        ...
        <div className="md:col-span-2 col-span-1 space-y-5">
          ...
          <p className="text-center text-[#5D6460]">
            Puliyur Perumal Temple, an ancient Hindu temple in Tamil Nadu, is
            dedicated to Lord Vishnu and is one of the 108 Divya Desams praised
            in the Divya Prabandham by the Alvar saints. According to legend,
            Sage Pulika Maharishi performed penance here, leading to the temples
            divine significance. Built in the Dravidian architectural style, the
            temple is over 1,000 years old and was patronized by Tamil dynasties
            like the Pallavas and Cholas. It enshrines Lord Kripasamudra Perumal
            with consorts Sridevi and Bhoodevi, attracting Vaishnavite devotees.
            Major festivals, including Vaikunta Ekadashi and Brahmotsavam, are
            celebrated here, making it a significant pilgrimage site.
          </p>
        </div>
        {/* col  */}
